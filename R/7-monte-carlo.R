...
write_csv(simulation_results, "data/alldpe_simulation2.csv")

# --- Visualisation ---

# Exemple d'utilisation de la fonction de visualisation
visualisation(df_filtered, simulation_results_CSV, "maison individuelle", "1978-1982", "Gaz")


# --- Compute prior and epsilon for each subgroup ---

# Initialize the df_metrics dataframe
df_metrics <- df

# Compute metrics on the default window 250–420 kWh/m² (threshold 330 kWh/m²)
...
# Compute metrics on the threshold 250 kWh/m²
...
# Compute metrics on the threshold 420 kWh/m²
