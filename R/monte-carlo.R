...
write_csv(simulation_results, "/Users/theophiledechelotte/Library/CloudStorage/OneDrive-Personnel/dpe-data/simulation_scott_last_certif_appartement_avant-1948_Electricite.csv")
